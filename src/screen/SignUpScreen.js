...
const SignUpScreen = ({navigation}) => {
  ...
  return (
    ...
    <View style={styles.container}>
            ...
            <View style={styles.inputout}>
                        <MaterialCommunityIcons name="lock-outline" size={24} color={confpasswordfocus == true ? colors.text1 : colors.text2} />
            ...
            <TouchableOpacity style={btn1} onPress={()=> handleSignup()}>
                <Text style={{ color: colors.col1, fontSize: 20, fontWeight: "bold" }}>Sign Up</Text>
            </TouchableOpacity>
